export class DistanceUnitChanger {
    ...
    // ------------------------------------------------------------------------
        ...
        public static meter_to_miles(distance: number, reverse=false) {
            if (reverse) {
                return this.meter_to_kilometer(this.kilometer_to_miles(distance, true), true)
            }
        ...
        public static meter_to_nautic_miles(distance: number, reverse=false) {
            if (reverse) {
                return this.meter_to_kilometer(this.kilometer_to_nautic_miles(distance, true), true)
            }
        ...
        public static kilometer_to_inches(distance: number, reverse=false) {
            if (reverse) {
                return this.meter_to_kilometer(this.meter_to_inches(distance, true),true)
            }
        ...
        public static centimeter_to_miles(distance: number, reverse=false) {
            if (reverse) {
                return this.kilometer_to_centimeter(this.kilometer_to_miles(distance, true), true)
            }
            return this.kilometer_to_miles(this.kilometer_to_centimeter(distance, true))
        }

        public static centimeter_to_inches(distance: number, reverse=false) {
            if (reverse) {
                return this.meter_to_centimeter(this.meter_to_inches(distance, true), true)
            }
        ...
        public static centimeter_to_yards(distance: number, reverse=false) {
            if (reverse) {
                return this.meter_to_centimeter(this.meter_to_yards(distance, true), true)
            }
        ...
        public static centimeter_to_nautic_miles(distance: number, reverse=false) {
            if (reverse) {
                return this.kilometer_to_centimeter(this.meter_to_nautic_miles(distance, true), true)
            }
            return this.kilometer_to_nautic_miles(this.kilometer_to_centimeter(distance, true))
        }

        public static millimeter_to_yards(distance: number, reverse=false) {
            if (reverse) {
                return this.meter_to_millimeter(this.meter_to_yards(distance, true), true)
            }
        ...
        public static millimeter_to_inches(distance: number, reverse=false) {
            if (reverse) {
                return this.meter_to_millimeter(this.meter_to_inches(distance, true), true)
            }
        ...
        public static millimeter_to_miles(distance: number, reverse=false) {
            if (reverse) {
                return this.kilometer_to_millimeter(this.kilometer_to_miles(distance, true), true)
            }
            return this.kilometer_to_miles(this.kilometer_to_millimeter(distance, true))
        }

        public static millimeter_to_nautic_miles(distance: number, reverse=false) {
            if (reverse) {
                return this.kilometer_to_millimeter(this.kilometer_to_nautic_miles(distance, true), true)
            }
            return this.kilometer_to_nautic_miles(this.kilometer_to_millimeter(distance, true))
        }
        ...
        public static yards_to_nautic_miles(distance: number, reverse=false) {
            if (reverse) {
                return this.meter_to_yards(this.meter_to_nautic_miles(distance, true), true)
            }
        ...
        public static inches_to_nautic_miles(distance: number, reverse=false) {
            if (reverse) {
                return this.meter_to_inches(this.meter_to_nautic_miles(distance, true), true)
            }
        ...
        public static miles_to_nautic_miles(distance: number, reverse=false) {
            if (reverse) {
                return this.meter_to_miles(this.meter_to_nautic_miles(distance, true), true)
            }
        ...
        public static nautic_miles_to_foot(distance: number, reverse=false) {
            if (reverse) {
                return this.meter_to_nautic_miles(this.meter_to_foot(distance, true), true)
            }
            return this.meter_to_foot(this.meter_to_nautic_miles(distance, true))
        }


        public static convert(distance: number, current_unit: string, new_unit:string) {
            switch(current_unit) {
                case "meter":
                    switch(new_unit) {
                        case "kilometer":
